...
`java.io.File` 类是**文件和目录路径名的抽象表示**，主要**用于文件和目录的创建、查找和删除等操作**。
...
* `public long length()`  ：返回由此File表示的文件的长度。 
  ...
  输出结果：
  文件绝对路径:/Users/messi433/IdeaProjects/JavaSEDemos/d:/aaa/bbb.java
  文件构造路径:d:/aaa/bbb.java
  文件名称:bbb.java
  文件长度:0字节
    
  目录绝对路径:/Users/messi433/IdeaProjects/JavaSEDemos/d:/aaa
  目录构造路径:d:/aaa
  目录名称:aaa
  目录长度:0
  ```
...
输出结果：
/Users/messi433/Downloads/test/file.java 是否存在:true
/Users/messi433/Downloads/test 是否存在:true
/Users/messi433/Downloads/test 文件?:false
/Users/messi433/Downloads/test 目录?:true
```
...
> API中说明：delete方法，如果此File表示目录，则目录**必须为空才能删除**。
...
file2.java
testson1
/Users/messi433/Downloads/test/testson2
/Users/messi433/Downloads/test/file1.java
/Users/messi433/Downloads/test/file2.java
/Users/messi433/Downloads/test/testson1
```

> 小贴士：
>
> 调用listFiles方法的File对象，表示的**必须是实际存在的目录**，否则返回null，无法进行遍历。
...
![](/Users/messi433/Desktop/Java基础/6-File类&IO流/img/2_copy.jpg)
...
计算机要准确的存储和识别各种字符集符号，需要进行字符编码，一套字符集必然至少有一套字符编码。常见字符集有ASCII字符集、GBK字符集、Unicode字符集等。![](/Users/messi433/Desktop/Java基础/6-File类&IO流/img/1_charset.jpg)
...
**转换流是字节与字符间的桥梁！**![](/Users/messi433/Desktop/Java基础/6-File类&IO流/img/2_zhuanhuan.jpg)
...
反之，该字节序列还可以从文件中读取回来，重构对象，对它进行**反序列化**。`对象的数据`、`对象的类型`和`对象中存储的数据`信息，都可以用来在内存中创建对象。看图理解序列化： ![](/Users/messi433/Desktop/Java基础/6-File类&IO流/img/3_xuliehua.jpg)
